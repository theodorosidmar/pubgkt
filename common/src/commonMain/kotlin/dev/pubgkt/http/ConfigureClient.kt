...
import dev.pubgkt.HEADER_RATE_LIMIT_RESET
import dev.pubgkt.HOST
import dev.pubgkt.NoRetry
 ...
 *
 * These exceptions are **never retried** regardless of [dev.pubgkt.RetryPolicy] configuration, because they
 ...
 * [dev.pubgkt.RetryPolicy] defined in [PubgApi.retry].
 *
