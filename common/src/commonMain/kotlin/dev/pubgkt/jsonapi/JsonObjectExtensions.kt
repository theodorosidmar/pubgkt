...
import dev.pubgkt.PubgktInternal
 ...
 */
@PubgktInternal
public fun JsonObject.requiredObject(key: String): JsonObject = this[key] as? JsonObject
 ...
 */
@PubgktInternal
public fun JsonObject.optionalObject(key: String): JsonObject? = this[key] as? JsonObject
 ...
 */
@PubgktInternal
public fun JsonObject.optionalArray(key: String): JsonArray? = this[key] as? JsonArray
 ...
 */
@PubgktInternal
public fun JsonObject.requiredInt(key: String): Int = optionalInt(
    key,
) ?: throw SerializationException("Missing int field '$key'")
 ...
 */
@PubgktInternal
public fun JsonObject.optionalString(key: String): String? = (this[key] as? JsonPrimitive)
    ?.let { primitive ->
 ...
 */
@PubgktInternal
public fun JsonObject.optionalInt(key: String): Int? = (this[key] as? JsonPrimitive)
    ?.let { primitive ->
 ...
 */
@PubgktInternal
public fun JsonObject.optionalDouble(key: String): Double? = (this[key] as? JsonPrimitive)
    ?.let { primitive ->
 ...
 */
@PubgktInternal
public fun JsonObject.optionalBoolean(key: String): Boolean? = (this[key] as? JsonPrimitive)
    ?.let { primitive ->
