...
/**
 * PUBG API wrapper to interact with PUBG API features like Players, Stats, Clans etc.
 *
    ...
    suspend fun getLifetimeStats(playerName: String, gameMode: GameMode): Result<Stats> =
        coroutineScope {
            runCatching {
                ...
                val lifetime: LifetimeResponse = client.getLifetimeStats(player, gameMode).body()
    ...
    suspend fun getLifetimeStats(playerNames: List<String>, gameMode: GameMode): Result<List<Stats>> {
        ...
        return coroutineScope {
            runCatching {
                ...
                val lifetime: LifetimeResponse = client.getLifetimeStats(players, gameMode).body()
