...
import dev.pubgkt.jsonapi.requiredArray
...
internal object MatchSerializer : JsonApiResourceDeserializer<Match>("pubgkt.matches.Match") {
    @Suppress("LongMethod")
    override fun deserializeResource(
        ...
        return Match(
            ...
            gameMode = MatchGameMode.valueOf(attributes.requiredString("gameMode").uppercase()),
                            ...
                            participants
                                ...
                                ?.let {
                                    MatchPlayer(
                                        ...
                                        deathType = DeathType.valueOf(
                                            it.requiredString("deathType").uppercase(),
                                        ),
